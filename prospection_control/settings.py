"""
Django settings for prospection_control project.
...
ROOT_URLCONF = 'prospection_control.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': ['prospection_control/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'prospection_control.wsgi.application'
